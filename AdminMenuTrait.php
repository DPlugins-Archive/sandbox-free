...
?>
        ...
        <div class="sandbox-card" data-id="false">
            <input type="radio" id="default" name="sandbox" value="false" <?php echo $selected_session == false ? 'checked' : ''; ?>>
        ...
        <?php foreach ($sessions['sessions'] as $key => $value) : ?>
            <div class="sandbox-card" data-id="<?php echo $value['id']; ?>">
                <input type="radio" name="sandbox" id="sandbox-<?php echo $value['id']; ?>" value="sandbox-<?php echo $value['id']; ?>" <?php echo $selected_session == $value['id'] ? 'checked' : ''; ?>>
                <div class="card-content">
                    <h2>
                        <label for="sandbox-<?php echo $value['id']; ?>"><?php echo $value['name']; ?></label>
                        <br>
                    </h2>
                    <input type="text" class="sandbox-description" placeholder="Click here to change the SandBox session name">
